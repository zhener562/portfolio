...
random.shuffle(deck)
pygame.font.init()
font=pygame.font.Font("japanese.otf",12)
class player:
    def __init__(self):
        self.health=20
        self.mana=0
    ...
    def check():
        hage=[]
        for i in p1.hand:
            hage.append(i.name+str(i.ManaCost))
        print(hage)
p1=player()
p2=player()
players=[p1,p2]
...
class cards(pygame.sprite.Sprite):
    def __init__(self,name,owner=p1,position=void,original="None"):
        ...
        self.owner=owner
        self.name=name
        self.image = pygame.image.load("swamp.png").convert_alpha()
        self.image = pygame.transform.scale(self.image,(108,150))
        w = self.image.get_width()
        h = self.image.get_height()
        self.power=sts[cl.index(self.name)][1]
        self.health=sts[cl.index(self.name)][2]
        self.ManaCost=sts[cl.index(self.name)][0]
        print(original)
        if original!="None":
        ...
        self.status=font.render(str(self.ManaCost)+" "+str(self.name),True,(0,0,0),(255,255,255))
        self.image.blit(self.status,[10,5])
        self.position=None
...
class hand(cards):
    def __init__(self,name,owner=p1,position=void):
        ...
        if self.owner==p2:
            self.rect.move_ip(0,abs(450-self.rect.top)-self.rect.top)
        self.image = pygame.image.load("MtgReverse.png").convert_alpha()
        self.image = pygame.transform.scale(self.image,(108,150))
    def update(self):
        self.image = pygame.image.load("MtgReverse.png").convert_alpha()
        self.image = pygame.transform.scale(self.image,(108,150))
